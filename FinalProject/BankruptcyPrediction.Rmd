...
datafile_name = "~/Github/Data Scientogolists/INSEADAnalytics/FinalProject/Data/data.csv"
...
independent_variables = c(2:95) # use all the available attributes
...
In order to build trust and investor confidence, market participants need to know whether or not the firm they are investing in will be financially solvent in the future. If the investing public is unable to identify and understand the financial risks of the company they are investing in, overall investment into the economy will decline. As foreign investment is critical for the growth of the economy of any nation, it is imperative that people can properly assess the risks associated with firms in the market. Greater transparency around financial distress and bankruptcy risk are vital for the investing public, as well as the entire economy. In this project we are evaluating several factors to predict bankruptcy of a company based on data from the Taiwanese economy. Findings from this analysis could extend to other markets across the globe as well.

# The Business Solution Process
The business problem is a classification problem. We have several dependent variables which we would utilize to identify the signals of bankruptcy and create a model that would be capable of predicting bankruptcy given a set of inputs based on a companies financial results.
