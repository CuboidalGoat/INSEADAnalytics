...
# # Let's get the decision of the lasso regression for the 3 types of data 
 validation_prediction_lasso_reg=1*as.vector(lasso_probabilities > 0.3)
...
#error here due to logistic regression failure/error: Error: dims [product 91] do not match the length of object [95]
...
#error here due to logistic regression failure/error. We dont have log_importance. Error: dims [product 91] do not match the length of object [95]
...
validation_predictions = rbind(validation_prediction_lasso_reg,
...
validation_hit_rates = rbind(
  100*sum(validation_prediction_lasso_reg==validation_actual)/length(validation_actual),
