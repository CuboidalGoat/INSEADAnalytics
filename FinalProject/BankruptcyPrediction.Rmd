...
columns_to_include = c(2,4,6,16,21,23)
...
#NEW_ProjectData_withB <- data.matrix(NEW_ProjectData_withB)
#NEW_ProjectData_withB_Lasso <- as.data.frame(NEW_ProjectData_withB)
...
# Please ENTER the attributes to use as independent variables. 
# Please use numbers, not column names. E.g., c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8.
independent_variables = c(2:7) # use all the available attributes
